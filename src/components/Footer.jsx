...
const Footer = () => {
  return (
    <footer className="bg-lightGray px-10 py-24 flex flex-col lg:flex-row justify-around text-#646874 text-sm gap-20 lg:gap-0">
      <div className="flex items-center lg:w-2/12 justify-center">
        <img src={Truck} alt='logo' className="lg:w-4/6"></img>  
      </div>
